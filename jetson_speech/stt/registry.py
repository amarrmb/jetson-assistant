...
if TYPE_CHECKING:
    from jetson_speech.stt.base import STTBackend
...
def _discover_backends() -> None:
    ...
    # Whisper backend
    try:
        from jetson_speech.stt import whisper  # noqa: F401
    except ImportError:
        pass

    # SenseVoice backend
    try:
        from jetson_speech.stt import sensevoice  # noqa: F401
    except ImportError:
        pass

    # vLLM Whisper backend (GPU-accelerated via remote vLLM server)
    try:
        from jetson_speech.stt import vllm_whisper  # noqa: F401
    except ImportError:
        pass

    # Nemotron Speech backend (NVIDIA NeMo, fast English STT)
    try:
        from jetson_speech.stt import nemotron  # noqa: F401
    except ImportError:
        pass
