"""
Remote engine that connects to a running jetson-assistant server.

This is the recommended approach for the voice assistant:
1. Start server once: `jetson-assistant serve`
...
from jetson_assistant.tts.base import SynthesisResult
from jetson_assistant.stt.base import TranscriptionResult, TranscriptionSegment
...
class RemoteEngine:
    """
    Engine that connects to a running jetson-assistant server.
    ...
    Usage:
        # Start server first: jetson-assistant serve
