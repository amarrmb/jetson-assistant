...
from jetson_assistant.config import get_config
...
class Engine:
    ...
    def synthesize_file(
        ...
        **kwargs,
        ...
        Returns:
            SynthesisResult with audio data
        """
        from jetson_assistant.core.audio import concatenate_audio, save_audio
    ...
    def say(
        ...
        **kwargs,
        ...
        """
        from jetson_assistant.core.audio import concatenate_audio, play_audio

        if stream:
            # Streaming playback
            from jetson_assistant.core.streaming import stream_and_play
