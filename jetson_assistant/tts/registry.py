...
if TYPE_CHECKING:
    from jetson_assistant.tts.base import TTSBackend
...
def _discover_backends() -> None:
    ...
    # Qwen backend
    try:
        from jetson_assistant.tts import qwen  # noqa: F401
    except ImportError:
        pass

    # Piper backend
    try:
        from jetson_assistant.tts import piper  # noqa: F401
    except ImportError:
        pass

    # Kokoro backend
    try:
        from jetson_assistant.tts import kokoro  # noqa: F401
    except ImportError:
        pass
